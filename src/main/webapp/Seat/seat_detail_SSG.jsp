			...
			<div class="container">
				<div class="row top-line animate-box">
					<div class="col-md-6 col-md-offset-3 col-md-push-2 text-left fh5co-heading">
						<h2 class="addfont">SSG 랜더스</h2>
					</div>
				</div>
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<p class="animate-box"><img src="/image/SSG_seat_detail.jpg" class="img-responsive" alt="Free HTML5 Template by FreeHTML5.co"></p>
						<div class="row row-pt-md portfolio-navigation">
							<div class="col-xs-4 text-left">
								<a href="/seatDetail?team=Kium" class="btn btn-primary btn-outline"><i class="icon-chevron-left"></i> Prev </a>
							</div>
