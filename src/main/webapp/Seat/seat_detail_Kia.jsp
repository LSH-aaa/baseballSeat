			...
			<div class="container">
				<div class="row top-line animate-box">
					<div class="col-md-6 col-md-offset-3 col-md-push-2 text-left fh5co-heading">
						<h2 class="addfont">KIA 타이거즈</h2>
					</div>
				</div>
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<p class="animate-box"><img src="/image/kia_seat_detail.png" class="img-responsive" alt="Free HTML5 Template by FreeHTML5.co"></p>
						<div class="row row-pt-md portfolio-navigation">
							<div class="col-xs-4 text-left">
								<a href="/seatDetail?team=Samsung" class="btn btn-primary btn-outline"><i class="icon-chevron-left"></i> Prev </a>
							</div>
							<div class="col-xs-4 text-center">
								<a href="/seat" class="btn btn-primary btn-outline"><i class="icon-grid2"></i> View All</a>
							</div>
							<div class="col-xs-4 text-right">
								<a href="/seatDetail?team=Hanhwa" class="btn btn-primary btn-outline">Next <i class="icon-chevron-right"></i></a>
							</div>
						</div>
					</div>
				</div>
